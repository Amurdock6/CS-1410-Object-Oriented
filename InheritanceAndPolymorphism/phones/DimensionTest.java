...
Exception exception = assertThrows(IllegalArgumentException.class, 
() -> {new Dimensions(13.6, 0, 9);});
assertEquals("The height, width, and depth of a dimension needs to be positive.", exception.getMessage()); }

@Test
void dimension_nonPositiveDepth_ThrowsIllegalArgumentException() {
assertThrows(IllegalArgumentException.class, () -> {new Dimensions(13.6, 10.3, 0);});
}

@Test
void dimension_negativeValues_ThrowsIllegalArgumentException() {
assertThrows(IllegalArgumentException.class, () -> {new Dimensions(-13.6, -10.3, -9);});
}
