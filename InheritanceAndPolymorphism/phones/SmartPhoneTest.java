...
SmartPhone smartPhone = new SmartPhone(160.4, 75.1, 8.2, "Pixel 4 XL", 128);
@Test
void smartPhone_initializesFields() {
SmartPhone smartPhone1 = new SmartPhone(150.9, 72.6, 7.7,"Samsung Galaxy", 64);
...
Exception exception = assertThrows(IllegalArgumentException.class, () -> new SmartPhone(150.9, 72.6, 7.7, "Samsung Galaxy", -64));
...
() -> new SmartPhone(150.9, 72.6, 7.7, "Samsung Galaxy", 0));
}
...
assertEquals("Pixel 4 XL (160.4 x 75.1 x 8.2) 128GB", 
smartPhone.toString());
}
}